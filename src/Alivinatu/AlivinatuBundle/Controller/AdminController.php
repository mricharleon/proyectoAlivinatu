...
class AdminController extends Controller {
    ...
    public function editarClienteAction($id) {
        ...
        if ($request->getMethod() == 'GET') {
            ...
            return $this->render('AlivinatuBundle:Administrador\Cliente:editarCuenta.html.twig', array('formAdmin' => $formAdmin->createView(),
                        'id' => $id)
            );
        }
    ...
    public function registroSalaAction() {
        ...
        return $this->render('AlivinatuBundle:Administrador\Sala:registroSala.html.twig', array('formSala' => $formSala->createView()
                ));
    }
    ...
    public function editarSalaAction($id) {
        ...
        if ($request->getMethod() == 'GET') {
            ...
            return $this->render('AlivinatuBundle:Administrador\Sala:editarSala.html.twig', array('formSala' => $formSala->createView(),
                        'id' => $id)
            );
        }
    ...
    public function registroServicioAction() {
        ...
        return $this->render('AlivinatuBundle:Administrador\Servicio:registroServicio.html.twig', array('formServicio' => $formServicio->createView(),
    ...
    public function editarServicioAction($id) {
        ...
        if ($request->getMethod() == 'GET') {
            ...
            $s = $_GET["nSala"];
            $sala = $em->getRepository('AlivinatuBundle:Sala')->findOneByNombreSala($s);
            
            $p = $_GET["nPromocion"];
            $promocion = $em->getRepository('AlivinatuBundle:Promocion')->findOneByNombrePromocion($p);

            $formServicio = $this->createForm(new ServicioType(), $servicio);

            return $this->render('AlivinatuBundle:Administrador\Servicio:editarServicio.html.twig', array('formServicio' => $formServicio->createView(),
...
//            ORDER BY s.nombre ASC");
            ...
            $query = $em->createQuery(
                            "UPDATE AlivinatuBundle:Servicio s
                                    SET s.nombre= :nombre,
                                    s.costo= :costo, s.descripcion= :descripcion
                                    WHERE s.id = :id"
    ...
    public function registroPromocionAction() {
        ...
        return $this->render('AlivinatuBundle:Administrador\Promocion:registroPromocion.html.twig', array('formPromocion' => $formPromocion->createView(),
                    'servicios' => $servicios
                ));
    }
    ...
    public function editarPromocionAction($id) {
        ...
        if ($request->getMethod() == 'GET') {
            ...
            return $this->render('AlivinatuBundle:Administrador\Promocion:editarPromocion.html.twig', array('servicios' => $servicios,
                        'formPromocion' => $formPromocion->createView(),
                        'id' => $id
                            )
            );
